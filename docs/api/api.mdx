...
Applies a React Beyond configuration to the component `cmp` and returns the new component. The configuration will be applied to all descendants of `cmp` as well.
